...
static elem_t *findByName(const csc_json_t *js, const char *name)
{   elem_t *els = js->els;
    int nEls = js->nEls;
    int i;
    for (i=0; i<nEls; i++)
...
void csc_json_addObj(csc_json_t *js, const char *name, csc_json_t *val)
{   val_t v;
    v.oVal = val;
...
void csc_json_addArr(csc_json_t *js, const char *name, csc_jsonArr_t *val)
{   val_t v;
    v.aVal = val;
